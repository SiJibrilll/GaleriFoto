<div class="p-4">
  ...
  <hr class="h-[1px] bg-gray-200 w-full mb-3">
        ...
        <ul class="space-y-4">
            ...
            <li wire:key='{{$comment->id}}' class="border-b border-gray-200 flex flex-row justify-between items-center">
                ...
                @if (Auth()->user()->id == $comment->user->id)
                  <svg wire:click='delete({{$comment->id}})' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-red-500">
    ...
    <div class="fixed bottom-0 inset-x-0 px-4 py-3 border-t bg-gray-50 flex items-center justify-between max-h-[10vh]">
        ...
        <svg wire:click="store" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 text-gray-200 ml-4">
